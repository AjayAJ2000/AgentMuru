...
function PlotComponent({ figure }) {
  ...
  reactExports.useEffect(() => {
    ...
    void __vitePreload(async () => {
      const { default: Plotly } = await import("./plotly.min-DY8iYp5R.js").then((n) => n.p);
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `bf-popup-shell bf-popup-${p.placement || "center"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { role: "dialog", "aria-modal": Boolean(p.backdrop), "aria-label": String(p.title || "Popup"), className: resolveMotionClass(p, [`bf-popup`, `bf-popup-${p.size || "sm"}`]), style: resolveMotionStyle(p), onClick: (e) => e.stopPropagation(), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bf-popup-header", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "bf-modal-close", onClick: () => ev("close"), "aria-label": `Close ${String(p.title || "popup")}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "X", size: 16 }) })
          ] }),
...
function createReconnectController(connect, schedule = window.setTimeout.bind(window), cancel = window.clearTimeout.bind(window)) {
  let attempt = 0;
  let timer = null;
  let disposed = false;
  const cancelPending = () => {
...
//# sourceMappingURL=index-BXRNQ0PT.js.map
